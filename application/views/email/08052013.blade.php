					...
					<tbody>
						...
						<tr>
							<td style="font-size:14px;font-family:'lucida grande',tahoma,verdana,arial,sans-serif;background:#ffffff;color:#000000;vertical-align:baseline;letter-spacing:-0.03em;text-align:left;padding:5px 20px">
								...
								<ul>Em 08 de Maio de 1970 os Beatles lançavam o seu álbum Let it Be. Aqui no Brasil a gente lança o Newsletter do MySkills. :)</ul>
								<ul>								
									<li><strong>Erro no acesso com Github</strong></a> 
										- Ao final de Abril o Github fez uma modificação na sua API de autenticação. Em função disso, alguns usuários do 
										MySkills não conseguiram conectar. A adaptação necessária já foi realiza e já está tudo funcionando corretamente.
										Caso ocorra algum novo problema, entrem em contato através do <a href="http://www.myskills.com.br/pt/channel" target="_blank"><strong>Canal de Atendimento.</strong></a>.</li>								
								</ul>
