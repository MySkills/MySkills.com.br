...
//      if  ($user_data['info']['uid'] == $existing_user->uid)
    ...
    switch($user_data['provider']) {
      case 'facebook' :        
        Fbk::postNewMessage($user_data, 'http://www.myskills.com.br/users/'.$user->id, $user->getImageUrl('normal'),'Agora faço parte da comunidade MySkills de Desenvolvedores. :)');
      break;
    }      
