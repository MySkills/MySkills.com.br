					...
					<tbody>
						...
						<tr>
							<td style="font-size:14px;font-family:'lucida grande',tahoma,verdana,arial,sans-serif;background:#ffffff;color:#000000;vertical-align:baseline;letter-spacing:-0.03em;text-align:left;padding:5px 20px">
								...
								<ul>
									<li><strong>Entendendo melhor a distribuição de badges</strong></a> 
										- As listagens de badges e tecnologias do MySkills são uma forma de você ficar atualizado com novidades, cursos e novas tecnologias.
										E ao mesmo tempo de identificar o que está sendo mais usado pela comunidade. Por isso, para refletir melhor essa relação entre o que é
										novidade e o que está sendo mais usado, dividimos a página de badge em duas colunas. Para cada categorias de badges, você agora terá os badges
										mais novos listados do lado esquerdo da tela. E do lado direito, os mesmos badges listados pela quantidade de usuários que possuem aquele
										badge. É uma forma de você identificar facilmente quais os novos badges e quais os mais relevantes para a comunidade.
										<a href="http://www.myskills.com.br/badges" target="_blank"><strong>Confira agora a nova listagem de badges.</strong></a>.</li>									
									<li><strong>Perfil com abas</strong></a> 
										- Para facilitar a visualização de dados no seu perfil, agora utilizamos abas. Acesse agora e veja como ficou o seu perfil.</strong></a>.
										Ordenador pela pontuação geral.</li>
									<li><strong>Usuários cadastrados</strong></a> 
										- Para você que gosta de acompanhar o crescimento do MySkills, adicionamos o total de usuários cadastrados logo na primeira página.
										<a href="http://www.myskills.com.br" target="_blank"><strong>Confira agora o tamanho da nossa comunidade.</strong></a>.</li>
								</ul>
