					...
					<tbody>
						...
						<tr>
							<td style="font-size:14px;font-family:'lucida grande',tahoma,verdana,arial,sans-serif;background:#ffffff;color:#000000;vertical-align:baseline;letter-spacing:-0.03em;text-align:left;padding:5px 20px">
								...
								<ul>Em 29 de Julho de 1836, após 30 anos, era inaugurado nem paris o Arco do Triunfo. Mas por aqui, é dia do newsletter do MySkills continuar decolando. :)</ul>
								<ul>								
									<li><strong>Links</strong> - Agora disponibilizamos a opção de compartilhamento de links. Agora além de compartilhar
										que tecnologia você utiliza, será possível também compartilhar links para bibliotecas, apis, widgets e ferramentas
										que vocÊ utiliza ou pretende utilizar. Semanalmente os links serão divulgados no boletim. 
										Para começar, compartilhamos dois links ligados a área de front-end, confiram. 
									</li>
								</ul>
