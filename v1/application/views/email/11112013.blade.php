					...
					<tbody>
						...
						<tr>
							<td style="font-size:14px;font-family:'lucida grande',tahoma,verdana,arial,sans-serif;background:#ffffff;color:#000000;vertical-align:baseline;letter-spacing:-0.03em;text-align:left;padding:5px 20px">
								...
								<ul>
									<li><strong>MySkills 2.0 preview</strong> - Final de ano chegando e estamos trabalhando na próxima versão do MySkills.
										Para você que quer dar uma olhadinha como está ficando essa nova versão, <a href="http://myskills2.gopagoda.com/" target="_blank"><strong>
										confira a versão 2.0 aqui.<strong></a> A mais nova funcionalidade será a capacidade de usar as moedas que você vem acumulando através
										dos seus checkins. Quanto mais moedas (e maior o seu nível), maior poder de influência você terá. Só para dar uma idéia do volume de checkins
										e geração de moedas, em breve chegaremos a um total de mais de 5.000 moedas geradas. E se você quiser contribuir codificando
										no Back-end ou front-end entre em contato, todo o código está disponível no Github.
									</li>
								</ul>
